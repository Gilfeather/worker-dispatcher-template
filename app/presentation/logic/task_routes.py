...
from ...infrastructure.db.repositories import SQLAlchemyTaskRepository, SQLAlchemyTaskResultRepository
from ..interface import get_dispatcher_service, get_task_repository, get_result_repository
from .schemas import TaskCreateRequest, TaskResponse, TaskUpdateRequest, TaskResultResponse
...
async def get_task_history(
    ...
    return [
        ...
        for result in results if isinstance(results, list)
    ]
